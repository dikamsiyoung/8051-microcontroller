...
setLcdFourBitMode:
	...
	call lcdByteSplitter		; In 4-bit mode, LCD module only takes one nibble at a time. This subroutine splits the command/data byte into nibbles
	...
	call lcdEnable				; This enable signal alerts the LCD that another nibble is coming in
...
clearMemory:					; This subroutine clears the contents stored in the memory location (50h+) defined with setMemoryLocation,
	call setMemoryLocation			; subroutine.
  loop:
	mov A, @R1
	cjne A, #00h, clear
	jmp done
